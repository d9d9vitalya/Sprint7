...
public class CreateOrderOneColorTest {

    public static int trackId2;
    ...
    public CreateOrderOneColorTest(String firstName, String lastName, String address, String metroStation, String phone, int rentTime, String deliveryDate, String comment, String color) {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"Test1", "Starikova", "Omsk", "2", "+7 800 111 11 11", 3, "2024-07-07", "2color", "[\"GREY\"]"}
        });
    }
    ...
    public void CreateOrderOneColorTest() {
        ...
        System.out.println("Создан заказ с одним Цветом, Трек номер: " + response.getBody().asString());

        trackId2 = response.jsonPath().getInt("track");
    }
}